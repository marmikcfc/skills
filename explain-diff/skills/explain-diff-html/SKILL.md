...
description: Create a rich, self-contained interactive HTML explanation of a code change, diff, branch, or pull request. Use when the user says "explain this diff", "explain this PR", "walk me through this branch", "make me an explainer for these changes", or wants the background, intuition, implementation, data flow, diagrams, or quiz-based reinforcement for a software change, with the result saved as a dated HTML file outside the repository.
---
...
If the user would rather have a hosted, shareable page than a local file, the same HTML can be published as an Artifact instead — it is already self-contained and CSP-safe by construction. Offer this; do not substitute it silently.

---

Adapted from [Geoffrey Litt's `explain-diff` gist](https://gist.github.com/geoffreylitt/a29df1b5f9865506e8952488eac3d524), incorporating the hardened revision contributed by [@yudhiesh-oc](https://gist.github.com/geoffreylitt/a29df1b5f9865506e8952488eac3d524?permalink_comment_id=6255388#gistcomment-6255388).
